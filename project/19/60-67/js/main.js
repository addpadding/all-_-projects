...
function Get__Storage__Task__60() {
    ...
    // task_s_60 = JSON.parse(localStorage.getItem("Kay_tasks_60"))

    //*
    let retrieved__Task__60 = JSON.parse(localStorage.getItem("Kay_tasks_60"))

    // if (retrieved__Task__60 == null) {
    //     task_s_60 = []
    // } else {
...
// let name_60 = localStorage.getItem("Kay_Name")
// alert(name_60)
...
document.getElementById("add_button").addEventListener("click", function () {
    ...
    // localStorage.setItem("Kay_Name", "Value_Yarob")
