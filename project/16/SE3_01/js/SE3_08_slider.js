...
const Arrayimg_88 = [
    //*
    `<img src="img-08/01.jpg" class="img_slider" alt="">`,

    `<img src="img-08/02.jpg" class="img_slider" alt="">`,

    `<img src="img-08/03.jpeg" class="img_slider" alt="">`,

    `<img src="img-08/04.jpg" class="img_slider" alt="">`,

    `<img src="img-08/05.jpg" class="img_slider" alt="">`
]
